...
void slSequencer::setup(){
    
    
}

void slSequencer::update(){
...
void slSequencer::execute(SequenceData *s){
...
void slSequencer::executeOneQuantum(quantum *q){
...
bool slSequencer::checkTheSequenceIsFinished(SequenceData *s){
